...
public class MenuMgr {
    ...
    // Appetizer
    /**
     * Function to delete an Appetizer from existing list based on ID
     * Print "Item not found" if ID doesnt exist
    ...
    // MainCourse
    /**
     * Function to delete a MainCourse from existing list based on ID
     * Print "Item not found" if ID doesnt exist
    ...
    // Dessert
    /**
     * Function to delete a Dessert from existing list based on ID
     * Print "Item not found" if ID doesnt exist
    ...
    // Drinks
    /**
     * Function to delete a Drinks from existing list based on ID
     * Print "Item not found" if ID doesnt exist
    ...
    // Packages
    /**
     * Function to delete a PackageItem from existing list based on ID
     * Print "Item not found" if ID doesnt exist
    ...
    //1 - Appetizer
    /**
     * Function to find and return an Appetizer using ID from existing list
     * return IndexOutOfBounds exception if ID not found
    ...
    //2 - Main Course
    /**
     * Function to find and return a MainCourse using ID from existing list
     * return IndexOutOfBounds exception if ID not found
    ...
    //3 - Drinks
    /**
     * Function to find and return a Drinks using ID from existing list
     * return IndexOutOfBounds exception if ID not found
    ...
    //4 - Dessert
    /**
     * Function to find and return a Dessert using ID from existing list
     * return IndexOutOfBounds exception if ID not found
    ...
    /**
     * Function to find and return a PackageItem using ID from existing list
     * return IndexOutOfBounds exception if ID not found
     ...
     * Find MainCourse first, then change name
     * Yield IndexOutOfBounds exception if item not found
     ...
     * Find Appetizer first,then change name
     * Yield IndexOutOfBounds exception if item not found
    ...
    //(iii)drinks
    /**
     * Function to change name of a Drinks item from existing Drinks list
     * Find Drinks first,then change name
     * Yield IndexOutOfBounds exception if item not found
    ...
    //(iv)dessert
    /**
     * Function to change name of a Dessert item from existing Dessert list
     * Find Dessert first,then change name
     * Yield IndexOutOfBounds exception if item not found
    ...
    //(v)packages
    /**
     * Function to change name of a PackageItem from existing PackageItem list
     * Find PackageItem first,then change name
     * Yield IndexOutOfBounds exception if item not found
     ...
     * Find MainCourse first,then change price
     * Yield IndexOutOfBounds exception if item not found
     ...
     * Find Appetizer first,then change price
     * Yield IndexOutOfBounds exception if item not found
    ...
    //(iii)drinks
    /**
     * Function to change price of a Drinks item from exisintg Drinks list
     * Find Drinks first,then change price
     * Yield IndexOutOfBounds exception if item not found 
    ...
    //(iv)dessert
    /**
     * Function to change price of a Dessert item from existing Dessert list
     * Find Dessert first, then change price
     * Yield IndexOutOfBounds exception if item not found
    ...
    //(v)packages
    /**
     * Function to change price of a PackageItem from existing PackageItem list
     * Find PackageItem first, then change price
     * Yield IndexOutOfBounds exception if item not found
     * @param id (String) ID of PackageItem to be updated
    ...
    //(i)Main Course
    /**
     * Function to change description of a MainCourse item from existing MainCourse list
     * Find MainCourse item first, then change description
     * Yield IndexOutOfBounds exception if item not found
     * @param id (String) ID of MainCourse to be updated
    ...
    //(ii)Appetizer
    /**
     * Function to change description of an Appetizer item from existing Appetizer list
     * Find Appetizer item first, then change description
     * Yield IndexOutOfBounds exception if item not found
     * @param id (String) ID of Appetizer to be updated
     ...
     * Find Drinks item first,then change description
     * Yield IndexOutOfBounds exception if item not found
     * @param id (String) ID of Drinks to be updated
     ...
     * Find Dessert item first,then change description
     * Yield IndexOutOfBounds exception if item not found
     * @param id (String) ID of Dessert to be updated
    ...
    //(v)Packages
    /**
     * Function to change description of a PackageItem from exisitng PackageItem list
     * Find PackageItem first, then change description
     * Yield IndexOutOfBounds exception if item not found
     * @param id (String) ID of PackageItem to be updated
