...
public class Table implements Serializable {
	...
	/**
	 * public : Table
	 * Constructor for a new Table with given tableNumber and tableSize
	 ...
	 * Function that returns the given tableNumber
	 ...
	 * Function to return the given tableSize
	 ...
	 * Function to set the tableSize with a given size
	 * @param tableSize (int)
	 */
	 ...
	 * Function to return the current status of a given Table
	 ...
	 * Function to set the given Table's status as EMPTY
	*/
	 ...
	 * Function to set the given Table's status as OCCUPIED
	*/
	 ...
	 * Function to set the given order to a Table
	 * @param order (Order)
	 */
	 ...
	 * Function to return the order for a given Table
	 ...
	 * Function to register the given Customer to a Table
	 ...
	 * Function to return the Reservation list for a given Table.
	...
	/**
	 * publiv void : addReservation
	 * Function to add a new Reservation to the given Table
